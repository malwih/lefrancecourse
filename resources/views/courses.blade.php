...
@section('container')
                ...
                <div class="slider">
                    ...
                    <div class="slide">
                        <img src="https://images.unsplash.com/photo-1541701494587-cb58502866ab?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                            alt="Slide 1" class="w-full h-auto">
                    </div>

                    <!-- Slide 2 -->
                    <div class="slide">
                        <img src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80"
                            alt="Slide 2" class="w-full h-auto">
                    </div>

                    <!-- Slide 3 -->
                    <div class="slide">
                        <img src="https://images.unsplash.com/photo-1561835491-ed2567d96913?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80"
                            alt="Slide 3" class="w-full h-auto">
                    </div>
                </div>
            </div>
        </div>
        ...
        @foreach ($courses as $course)
            <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
                ...
                <div class="my-4">
                    ...
                    <a href="/register">
                    <button class="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">Register
                        Sekarang</button>
                        </a>
                </div>
            </div>
    ...
    <div class="bg-gray-100 py-2">
        <div class="container mx-auto px-10">
            <h2 class="flex justify-center text-3xl font-bold text-orange-500 mb-6 py-8">News
            </h2>
                            ...
                            @if ($course->image)
                                <a href="/courses/{{ $course->slug }}">
                                    <img class="object-cover rounded-t-lg w-full h-full img-fluid"
                                        src="{{ asset('storage/' . $courses[0]->image) }}">
                                </a>
                            @else
                                <a href="/courses/{{ $course->slug }}">
