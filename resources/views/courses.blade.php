...
<div class="min-h-screen bg-gradient-to-tr from-orange-300 to-orange-200 flex justify-center items-center py-20">
    <div class="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
        ...
        <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            <div class="relative">
                <img class="w-full rounded-xl" src="{{ asset('storage/' . $course->image) }}" />
            ...
            <div class="shadow-lg rounded-lg">
                <div class="relative overflow-hidden">
                    ...
                    <a href="/courses/{{ $course->slug }}">
                        <img class="object-cover rounded-t-lg w-full h-full img-fluid" src="{{ asset('storage/' . $courses[0]->image) }}">
                    </a>
                    @else
                    <a href="/courses/{{ $course->slug }}">
