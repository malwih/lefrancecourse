...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="text-3xl font-bold text-black mb-6">Create New Class</h1>
</div>
<div class="col-lg-8">
  <form method="post" action="/dashboard/courses" class="mb-5" enctype="multipart/form-data">
    ...
    <button type="submit" class="text-white bg-orange-500 hover:bg-orange-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create Class</button>
  </form>
</div>
    </div>
</div>
