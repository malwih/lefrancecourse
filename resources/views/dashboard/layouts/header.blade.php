  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/dashboard" class="flex ms-20 md:me-24">
      ...
      @auth
        ...
        <div id="multi-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
                <li>
                    <a href="/dashboard" class="dropdown-item block px-4 py-2 hover:bg-gray-100 dark:hover:bg-orange-500 dark:hover:text-white">My Dashboard</a>
                </li>
                <li>
