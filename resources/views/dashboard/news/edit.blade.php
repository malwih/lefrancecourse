        ...
        <div class="col-lg-8">
            <form method="post" action="/dashboard/news/{{ $news->slug }}" class="mb-5" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if($news->image)
                    <img src="{{ asset('storage/' . $news->image) }}" class="w-1/2 h-1/2 img-preview img-fluid mb-3 mt-3 col-sm-5 d-block">
                    @else
                ...
                <button type="submit" class="text-white bg-orange-500 hover:bg-orange-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Update News</button>
            </form>
        </div>
    </div>
</div>
