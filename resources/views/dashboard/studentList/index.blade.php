...
<div class="p-10 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-20">
        ...
        <a href="{{ route('studentlist.pdf') }}" class="btn btn-primary">Generate PDF</a>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-100 dark:border-gray-700">
                        ...
                        <td class="flex col-lg-8 mt-5">
                            ...
                            <a href="{{ route('studentlist.edit', $student->id) }}">
                                <span data-feather="edit" class="ml-2 mr-2 bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-1 px-1 rounded"></span>
                            </a>
