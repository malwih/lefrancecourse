...
<section class="p-20 dark:bg-gray-100 dark:text-gray-100">
    <div class="mc4up-form-fields">
        <div class="es-field-wrap wrapemail" style="margin-bottom: 0px">
            <input class="es_required_field es_txt_email ig es_form_field_email mt-1 p-1 border rounded-md" type="email" name="EMAIL" placeholder="Your email address" style="padding: 4px" fdprocessedid="7ivk73">
            <span class="es_spinner image spinnercusti" style="display: none" id="spinner-image"></span>
            <input type="submit" value="Send" class="px-2 py-1 bg-blue-500 text-white rounded-md text-xs" id="es_subscription_form_submit_1" fdprocessedid="tqruts">
        </div>
    </div>
    ...
    <div class="container grid gap-2 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
        <div class="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-white">
            ...
            <form novalidate="" action="" class="self-stretch space-y-3">
                <a href="/register"><button type="button" class="w-full py-2 font-semibold rounded dark:bg-orange-500 hover:bg-orange-400 dark:text-white">Join
