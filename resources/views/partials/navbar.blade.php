    ...
    <div class="border flex items-center px-4 lg:px-6 xl:px-8">
        ...
        <div id="multi-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-black">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
                <li>
                    <a href="/dashboard" class="dropdown-item block px-4 py-2 hover:bg-gray-100 dark:hover:bg-orange-400 dark:hover:text-white">My
                        Dashboard</a>
                </li>
                <li>
                    <form action="/logout" method="post">
                        @csrf
                        <button type="submit" class="flex justify-left w-full dropdown-item px-4 py-2 hover:bg-gray-100 dark:hover:bg-orange-400 dark:hover:text-white"><img class="w-4 h-4 flex items-center self-center mr-1.5" src="../storage/icon/icon-logout.png" alt="">Logout</button></a>
                    </form>
                </li>
            </ul>
        </div>
